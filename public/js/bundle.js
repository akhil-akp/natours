...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiYWtoaWwyMDIwIiwiYSI6ImNsMjV2YTRuYzA1N3IzYnIyZHNpd2FoZ2gifQ.wyfWrooJ5UNLSHE06aNS9w';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/akhil2020/cl260jpga00hc14mqayqmtqym',
    // style URL
    scrollZoom: false //   center: [83.02638, 25.37441], // starting position [lng, lat]
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? ' http://127.0.0.1:3000/api/v1/users/updateMyPassword' : 'http://127.0.0.1:3000/api/v1/users/updateMyData';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tourId) {
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            stripe = Stripe('pk_test_51KrcYDSGJC0BE6s8bXn6oxbPSZ69nLI5ogr4AuJm9jpcewUaB6hwrBDw5j2n3diFBKqzIKtUToXdTr0DDqkHO8Ke00vBdgGHDs');
            _context.prev = 1;
            _context.next = 4;
...
var bookBtn = document.getElementById('book-tour'); //DELIGATIONS
